...
$(combo_2nd_arch_prefix)TARGET_arm_CFLAGS := -O2 -fomit-frame-pointer -fstrict-aliasing -funswitch-loops $(VANIR_ARM_FSTRICT_OPTIONS)
$(combo_2nd_arch_prefix)TARGET_thumb_CFLAGS := -mthumb -Os -fomit-frame-pointer -fno-strict-aliasing $(VANIR_ARM_FSTRICT_OPTIONS)
endif
