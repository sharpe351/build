...
$(combo_var_prefix)GLOBAL_CFLAGS := -fno-exceptions -Wno-multichar $(VANIR_GLOBAL_CFLAGS)
$(combo_var_prefix)RELEASE_CFLAGS := -O2 -g -fno-strict-aliasing $(VANIR_RELEASE_CFLAGS)
$(combo_var_prefix)GLOBAL_CPPFLAGS := $(VANIR_GLOBAL_CPPFLAGS)
$(combo_var_prefix)GLOBAL_LDFLAGS := $(VANIR_GLOBAL_LDFLAGS)
